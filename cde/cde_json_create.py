...
cde_json["minimumInstances"] = cde_infra_info["minimum_instances"]
cde_json["maximumInstances"] = cde_infra_info["maximum_instances"]
cde_json["initialInstances"] = cde_infra_info["initial_instances"]
cde_json["minimumSpotInstances"] = cde_infra_info["minimum_spot_instances"]
cde_json["maximumSpotInstances"] = cde_infra_info["maximum_spot_instances"]
...
cde_json["rootVolumeSize"] = cde_infra_info["root_volume_size"]
